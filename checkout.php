    ...
    <main role='main' style='z-index:290;' class='animate-bottom'>
      <article itemscope itemtype='http://schema.org/checkoutPage'>
		...
		<div style='height:55%; background:#eee; width:100%;'>$assetB</div>
              ...
              <div style='position:fixed; bottom:0; display:flex; flex-direction:column; justify-content:center; align-items:center; width:100%; padding: 6px 30px 6px 30px; color:deepskyblue;'>
                <div style='background:rgba(255, 255, 255, .6); padding:10px; border-radius:10px; display:flex; flex-direction:column; justify-content:center; align-items:center;'><span style='font-size:18px; margin-bottom:1px; font-weight:bold;'>Not on Glit yet?</span>
