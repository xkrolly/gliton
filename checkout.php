      ...
      <article itemscope itemtype='http://schema.org/checkoutPage'>
		...
		<div style='height:55%; background:#eee; width:100%;'>$assetB</div>
              ...
              <div style='position:fixed; bottom:0; display:flex; flex-direction:column; justify-content:center; align-items:center; width:100%; padding: 6px 30px 6px 30px;'>
                <div style='background:rgba(255, 255, 255, .6); padding:10px; border-radius:10px; display:flex; flex-direction:column; justify-content:center; align-items:center;'><span style='font-size:18px; margin-bottom:1px; font-weight:bold; color:#555;'>Not on Glit yet?</span>
		<span style='font-size:9px; margin:8px 10px 8px 10px; '>There are lots a solutions built on Glit already. You can as well benefit from this by simply signing up to access lots more for free.</span>
