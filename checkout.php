      ...
      <article itemscope itemtype='http://schema.org/checkoutPage'>
		...
		<div style='height:55%; background:#eee; width:100%;'>$assetB</div>
              ...
              <div style='position:fixed; top:70%; display:flex; flex-direction:column; justify-content:center; align-items:center; width:100%;'>
                <div style='background:rgba(255, 255, 255, .3); padding:10px; border-radius:10px; display:flex; flex-direction:column;'><span style='font-size:10px;'>Not on Glit yet?</span>
