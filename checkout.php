    ...
    <main role='main' style='z-index:290;' class='animate-bottom'>
      <article itemscope itemtype='http://schema.org/checkoutPage'>
		...
		<div style='height:55%; background:#eee; width:100%;'>$assetB</div>
              ...
              <div style='position:fixed; top:70%; display:flex; flex-direction:column; justify-content:center; align-items:center; width:100%; color:#2166f3;'>
                <div style='background:rgba(255, 255, 255, .3); padding:10px; border-radius:10px; display:flex; flex-direction:column; justify-content:center; align-items:center;'><span style='font-size:18px; margin-bottom:3px; font-weight:bold;'>Not on Glit yet?</span>
                ...
                <span style='font-size:10px; color:#555;'>Access lots more for free!</span>
		</div>
              </div>
