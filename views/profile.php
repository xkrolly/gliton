...
foreach($_favourites as $fav){
    ...
    $media == 3 ? $mediaDisplay = "<video class='flexible2' id='$eachFav[3]' style='border-radius:4px; border:1px solid #aaa; width:100%; height:104px; object-fit:cover; background:#fff;' src='videos/".$dir."/dec/".$thumbnail.".webm'></video>" : $mediaDisplay ="<img class='flexible' id='$eachFav[3]' style='border-radius:4px; border:1px solid #aaa; width:96px; height:104px; object-fit:cover; background:#fff;' src='img/".$dir."/".$thumbnail.".webp' />";
