...
//coin balance
	...
	return "<div style='display:flex; height:100vh; width:100vw; justify-content:center; padding-top:65%;'>
			<div style='font-size:14px; width:70%; text-align:center; font-family:serif;'>
			   ...
			   <h2>Awesome!!! </h2>
			   <div style='font-size:20px; font-family:serif;'>Your purchase of <span style='font-style:italic; text-decoration:underline; font-family:serif;'>".$heading."</span> 
                		<span style='font-style:italic; font-family:serif;'>solscript</span> was successful. You can now freely access it through search and/or scrolls. Thanks. <p style='font-style:italic; color:#2166f3; margin-top:10px; font-size:16px;'>Your Glitcoin balance is <strong>$coinBal</strong><sup style='font-size:8px;'>GC</sup>.</p></div>
